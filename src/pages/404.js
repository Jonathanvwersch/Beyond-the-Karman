...
const NotFoundPage = () => (
  <div className="flex items-center absolute inset-0 justify-center text-center px-6 bg-cover bg-404-image">
    <SEO title="404" />
    <div className="flex items-center justify-center flex-col">
      <h1 className="text-white max-sm:text-3xl text-4xl mb-6">You're lost in the abyss</h1>
      <Link to="/">
        <button className="rounded bg-white text-black p-2 font-mono hover:bg-gray-200 active:bg-gray-400">Return home</button>
      </Link>
