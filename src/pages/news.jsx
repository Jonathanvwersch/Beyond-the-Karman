...
const News = () => {
  ...
  return (
    <Layout>
      <SEO title="News" />
      {news ? (
        <div className="btk-container bg-launch-image bg-cover">
          <div className="btk-container-inner flex-col">
            <h1 className="text-white mt-10 text-2xl mb-10 md:text-4xl">
              Latest Stories
            </h1>
            <div className="flex flex-col md:flex-none md:grid md:grid-cols-2 md:gap-4 ">
            ...
            <h2 className="text-white mt-16 text-xl mb-10 md:text-3xl">
              More Stories
            </h2>
