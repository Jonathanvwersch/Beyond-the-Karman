...
const Header = () => {
  ...
  return (
    <header className="btk-container fixed z-50 bg-black select-none top-0 left-0 right-0 overflow-hidden">
      <div className="btk-container-inner justify-between items-center">
